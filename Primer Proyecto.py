...
listprovince=[{'provincia': 'ALAJUELA', 'cantones': [{'canton': 'SAN CARLOS', 'distritos': [{'distrito': 'SANTA CLARA', 'PresidentialVotes': [{'party': 'PAC', 'votes': '900'}, {'party': 'PUSC', 'votes': '1200'}, {'party': 'FA', 'votes': '300'}], 'LegislativeVotes': [{'party': 'PAC', 'votes': '400'}, {'party': 'PUSC', 'votes': '700'}, {'party': 'FA', 'votes': '0'}]}]}], 'ballots': [{'Papeleta Legislativa': [{'party': 'PAC'}, {'party': 'PUSC'}, {'party': 'FA'}]}], 'diputies': 6}, {'provincia': 'SAN JOSE', 'cantones': [{'canton': 'HATILLO', 'distritos': [{'distrito': 'DISTRITO', 'PresidentialVotes': [{'party': 'PAC', 'votes': '500'}, {'party': 'PUSC', 'votes': '900'}, {'party': 'FA', 'votes': '0'}], 'LegislativeVotes': [{'party': 'PAC', 'votes': '300'}, {'party': 'PUSC', 'votes': '400'}, {'party': 'FA', 'votes': '0'}]}]}], 'ballots': [{'Papeleta Legislativa': [{'party': 'PAC'}, {'party': 'PUSC'}, {'party': 'FA'}]}], 'diputies': 6}]#list, where are the provinces, the cantons, the districts.
